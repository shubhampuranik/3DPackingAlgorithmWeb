...
import mylogic.Orders;

/**
 *
 * @author LG-2
 */
@WebServlet(urlPatterns = {"/NewServlet_1"})
public class NewServlet_1 extends HttpServlet {
    public String json1;
    /**
...
//            out.println("Selected Item:- "+request.getParameter("state_name"));
//            out.println("<p>"+session.getAttribute("JSON")+"</p>");
