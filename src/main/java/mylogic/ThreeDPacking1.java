...
public class ThreeDPacking1 {
    ...
    public ThreeDPacking1(){
        bin=new Cuboid(200,500,200,5);
        bin.setBottomLeftRear(new Point(0,0,0));
        inputCuboids=new ArrayList<Cuboid>();
        Random r=new Random();
        for(int i=0;i<60;i++)
            inputCuboids.add(new Cuboid((r.nextInt(5)+1)*20,(r.nextInt(5)+1)*20,(r.nextInt(5)+1)*20,(r.nextInt(5)+1)*20));
